...
namespace Game.Assets.Scripts.Game.Logic.Models.Services.Resources.Points.BuildingPointsAnimations
{
    public class AddPointsAnimation : Disposable
    {
        ...
        public AddPointsAnimation(int points, ConstructionsSettingsDefinition constructionsSettings, IGameTime time, GameVector3 postion)
            : this(points, constructionsSettings.PieceSpawningTime, constructionsSettings.PieceMovingTime, time, postion)
        {

        }

        public AddPointsAnimation(int points, float pieceSpawningTime, float pieceMovingTime, IGameTime time, GameVector3 postion)
        {
